...
# ---------------------------------------------------------
# 1. Token & API Configuration (Via Streamlit Secrets)
# ---------------------------------------------------------
DISCORD_TOKEN = st.secrets.get("DISCORD_TOKEN") or os.getenv("DISCORD_TOKEN")
GROQ_API_KEY = st.secrets.get("GROQ_API_KEY") or os.getenv("GROQ_API_KEY")
STREAMLIT_URL = st.secrets.get("STREAMLIT_URL", "https://nama-app-kamu.streamlit.app")

if not DISCORD_TOKEN or not GROQ_API_KEY:
    print("❌ ERROR: Token Discord atau API Key Groq belum dimasukkan di Streamlit Secrets!")
    exit()
